...
//The third person control that works with a virtual joystick
public class ThirdPersonJoystickControl : MonoBehaviour {
	...
	private float h, v; //The values on the joystick to move by
	...
	private void On_JoystickMove(MovingJoystick move) {
		if (move.joystickName == "Left Joystick") {
